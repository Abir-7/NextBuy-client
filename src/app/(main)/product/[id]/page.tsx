...
const ProductDetails = () => {
  ...
  const product = {
    ...
    description:
      "Experience the ultimate comfort and style with these high-quality sneakers. Perfect for casual wear and sports.",
    price: 120,
    sizes: ["S", "M", "L", "XL"],
    images: [
      "https://img.freepik.com/free-photo/pair-trainers_144627-3809.jpg",
      "https://img.freepik.com/free-photo/pair-trainers_144627-3810.jpg",
      "https://img.freepik.com/free-photo/pair-trainers_144627-3798.jpg",
    ],
  };
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex flex-col gap-4 w-full lg:w-1/2">
          <Image
            ...
            alt={product.title}
            className="w-full h-80 sm:h-96 md:h-[400px] lg:h-[500px] object-cover rounded-lg border"
          />
